...
function figure_2_3(;k = 10, ϵ = 0.1, Qinit = 5.0, α=0.1)
	...
	plot([t1, t2], Layout(xaxis_title = "Step", yaxis = attr(title = "% Runs Taking Optimal Action", range = [0, 1]), legend = attr(orientation = "h", y = 1.1), width = 700, height = 400, title = "$k Armed Testbed, α = $α", hovermode = "x unified"))
end
...
function figure_2_4(;k = 10, c = 2.0, ϵ = 0.1)
	...
	plot([t1, t2, t3], Layout(xaxis_title = "Step", yaxis_title = "Reward per Step Averaged Over Runs", title = "$k armed testbed average performance", legend = attr(orientation = "h", y = 1.1), hovermode = "x unified"))
end
