...
HTML("""
<div style = "display: flex; align-items: flex-end; justify-content: space-between; background-color: white; color: black; font-size: max(18px, 1vw); width: min(800px, 70vw)">
	<div style = "width: min(10vw, 90px); margin-left: 20px;">1-step TD <br> and TD(0)</div>
	<div style = "width: min(10vw, 90px); margin-left: 20px;">2-step TD</div>
	<div style = "width: min(10vw, 90px); margin-left: 20px;">3-step TD</div>
	<div style = "width: min(10vw, 90px);"></div>
	<div style = "width: min(10vw, 90px); margin-left: 0px;">n-step TD</div>
	<div style = "width: min(10vw, 90px);"></div>
	<div style = "width: min(10vw, 90px); margin-right: 5px;">&infin;-step TD <br> and Monte Carlo</div>
</div>
<div style = "display: flex; align-items: flex-start; justify-content: space-between; width: min(800px, 70vw); background-color: white; padding: 5px;">
...
manifest_format = "2.0"
project_hash = "3f884fa9685d3429cf9f06053bf00290ad599f65"
