...
export semi_gradient_sarsa_linear, semi_gradient_double_sarsa_linear, semi_gradient_dp_linear, semi_gradient_expoeted_sarsa_linear, semi_gradient_q_learning_linear, semi_gradient_differential_sarsa_linear, semi_gradient_differential_sarsa_fcann
...
export setup_mountaincar_tiles
...
export AbstractEligibilityVector, LinearEligibilityVector, NonLinearEligibilityVector

export reinforce_monte_carlo_control_linear, reinforce_monte_carlo_control_fcann

export setup_fcann_policy_arguments, form_policy_and_value_function
